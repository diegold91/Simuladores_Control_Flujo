...
public class Main {
	...
	public static void main(String[] args) {
		...
		imprimirCola(cola);
		int numeroBytes=500000; // Número de bytes a transmitir
		int tamanoVentana=65536; // 1024, 2048, 4096, 8192, 16384, 32768, 65536
	...
	public static Queue<Byte> crearCola() {
        /*Se crea la cola Indicando el tipo de dato*/
